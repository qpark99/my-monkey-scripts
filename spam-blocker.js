...
(function() {
    ...
    const keywords = [
        ...
        '원피스', '레버리지', '홈플러스', 'MCU', '스파이더맨', '구마모토', '쿠마모토', '이온몰', '인권법', '하이닉스',
        '하닉', '혐한', '일뽕', '나노하', '돌려차기', '활협전', '한요일', '음주운전', '미장', '성접대',
        '오디세이', '오딧세이', '그래미', '열돔', '증시', '종부세', '하영', '친일', '이완용', '안상호',
        '민영화', '오버워치', '옵치', '돌핀', '태풍', '마이크론', '박위', '위라클', '제주', '장미란',
        '라이자', '전현무', '박수홍', '식객', '애플', '위쳐', '블리치', '워해머', '붉은사막', '케데헌',
        '부정선거', '아이폰', '폴드', '닌다', '젤다', '도로롱', '초파리', '제노블', 'GTA', '마비m',
        '니케', '마운자로', '양구', '스토크스', '스톡스', '부정수급', '야차룰',
        ]; // 원하는 키워드로 수정
