...
(function() {
    ...
    const keywords = [
        ...
        '차은우', '탈세', '담합', '연봉', '실수령', '퐁퐁', '이스라엘', '선관위', '투표용지', '개표',
        '투표소', '전한길', '모스탄', '윤어게인', '검열', '허위조작정보', '탱크데이', '멸공', '환율', '코스피',
        '선거', '안협소', '시위', 'MBC', '투표율', '리센느', '트릭컬', '미실현', '주식', '폭락',
        '홍명보', '홍감독', '클린스만', '벤투', '황선홍', '신태용', '이임생', '이강인', '김민재', '황희찬',
        '황인범', '조규성', '오현규', '박지성', '이영표', '안정환', '감스트', '김병현', '축협', '국축',
        '해축', 'A매치', '평가전', 'K리그', '피파', 'FIFA', '흥민', '몽규', '배재고', '김호중',
        '피카소', '졌잘싸', '16강', '난임병원', '냉부', '시크릿 책', '원피스', '레버리지', '홈플러스', 'MCU',
        '스파이더맨', '구마모토', '쿠마모토', '이온몰', '인권법', '하이닉스', '하닉', '혐한', '일뽕', '나노하',
        '돌려차기', '활협전', '한요일', '호프', '음주운전', '미장', '성접대', '오디세이', '오딧세이', '그래미',
        '열돔', '증시', '종부세', '하영', '친일', '이완용', '안상호', '후손', '민영화', '오버워치',
        '옵치', '돌핀', '태풍', '택시', '마이크론', '교도소',
        ]; // 원하는 키워드로 수정
