...
(function() {
    ...
    const keywords = [
        ...
        '뺑소니', '쿠팡', '삼전', '스벅', '스타벅스', '정용진', '일베', 'snl', '영포티', '짱깨',
        '우크라', '자살', '슈카', '의새', '다케시마', '빽보이', '빽다방', '그알', '알고싶다', '앱스타인',
        '엡스타인', '오킹', '논란', '우왁굳', '굴단', '페미', '왁타', '차은우', '탈세', '담합',
        '실수령', '퐁퐁', '이스라엘', '선관위', '투표용지', '개표', '투표소', '전한길', '모스탄', '윤어게인',
        '허위조작정보', '탱크데이', '멸공', '환율', '코스피', '안협소', '시위', 'MBC', '투표율', '리센느',
        '트릭컬', '미실현', '주식', '폭락', '홍명보', '홍감독', '클린스만', '벤투', '황선홍', '신태용',
        '이임생', '이강인', '김민재', '황희찬', '황인범', '조규성', '오현규', '박지성', '이영표', '안정환',
        '감스트', '김병현', '축협', '국축', '해축', 'A매치', '평가전', 'K리그', '피파', 'FIFA',
        '흥민', '몽규', '배재고', '김호중', '피카소', '졌잘싸', '16강', '난임병원', '냉부', '시크릿 책',
        '원피스', '레버리지', 'MCU', '구마모토', '쿠마모토', '이온몰', '인권법', '하닉', '혐한', '일뽕',
        '나노하', '돌려차기', '활협전', '한요일', '음주운전', '미장', '성접대', '오디세이', '오딧세이', '그래미',
        '열돔', '증시', '종부세', '친일', '이완용', '안상호', '민영화', '오버워치', '옵치', '돌핀',
        '태풍', '마이크론', '박위', '위라클', '장미란', '라이자', '전현무', '박수홍', '식객', '애플',
        '위쳐', '블리치', '워해머', '붉은사막', '케데헌', '부정선거', '아이폰', '폴드', '닌다', '젤다',
        '도로롱', '초파리', '제노블', 'GTA', '마비m', '니케', '마운자로', '양구', '스토크스', '스톡스',
        '부정수급', '야차룰', '배그', '배틀그라운', 'PUBG', '펍지', '크래프톤', '백억커피', '베트남', '상어',
        '아시안', '러시아', '울버린', '명조',
        ]; // 원하는 키워드로 수정
